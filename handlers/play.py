...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "**sᴍᴏᴋᴇʀ ᴍᴜꜱɪᴄ ᴀꜱꜱɪꜱᴛᴀɴᴄᴇ ᴊᴏɪɴ ꜰᴏʀ ᴘʟᴀʏ ʙᴇꜱᴛ Qᴜᴇʟɪᴛʏ ᴍᴜꜱɪᴄ🎶**")
                ...
                [
                    [
                        InlineKeyboardButton(
                            text="ᴄʜᴀɴɴᴇʟ",
                            url=f"https://t.me/SankiPelaiSenter")
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png", 
        caption=f"#⃣ ʏᴏᴜʀ ʀᴇQᴜᴇꜱᴛᴇᴅ ꜱᴏɴɢ **queued** ᴀᴛ ᴘᴏꜱɪᴛɪᴏɴ {position}!",
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="▶️ **Playing** ʜᴇʀᴇ ᴛʜᴇ ꜱᴏɴɢ ʀᴇQᴜᴇꜱᴛᴇᴅ ʙʏ {} ᴠɪᴀ ʏᴏᴜᴛᴜʙᴇ 🎵".format(
